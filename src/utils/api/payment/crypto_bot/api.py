...
from .types.currencies import Currency
from .types.invoice import Invoice
from .types.profile import Profile
from .types.rates import ExchangeRate
from .types.transfer import Transfer
from .types.update import Update
from .utils.exchange import get_rate, get_rate_summ
from .base import CryptoBotBaseClient


class CryptoBotApi(CryptoBotBaseClient):
    API_DOCS = "https://help.crypt.bot/crypto-pay-api"

    def __init__(
        self, token: str, network: Union[str, Network] = Network.MAIN_NET
    ) -> None:
        super().__init__()
        """
    ...
    async def create_invoice(
        ...
        accepted_assets: Optional[Union[List[Union[Asset, str]], str]] = None,
    ) -> Invoice:
        """
        ...
        Args:
            asset (Optional[Union[Asset, str]]): Currency code if the field currency_type has crypto as a value. Supported assets: “USDT”, “TON”, “BTC”, “ETH”, “LTC”, “BNB”, “TRX” and “USDC”.
            amount (Union[int, float]): Amount of the invoice in float or int. For example: 125.50
            description (Optional[str], optional): Description for the invoice. User will see this description when they payment the invoice. Up to 1024 characters.
            ...
            allow_anonymous (Optional[bool], optional): Allow a user to payment the invoice anonymously. Default is true.
            ...
            accepted_assets (Optional[Union[List[Union[Asset, str]], str]], optional): Asset which can be used to payment the invoice if the field fiat has a value. Supported assets: “USDT”, “TON”, “BTC” (and “JET” for testnet). Defaults to all currencies.
    ...
    async def get_invoices(
        ...
        """
        Use this method to get invoices for your app.
        https://help.crypt.bot/crypto-pay-api#getInvoices

        Args:
            asset (Optional[Union[Asset, str]], optional): Cryptocurrency alphabetic code. Supported assets: “USDT”, “TON”, “BTC”, “ETH”, “LTC”, “BNB”, “TRX” and “USDC” (and “JET” for testnet). Defaults to all currencies.
    ...
    async def delete_invoice(self, invoice_id: int) -> bool:
        ...
        https://help.crypt.bot/crypto-pay-api#34Hd
    ...
    async def transfer(
        ...
        Args:
            ...
            asset (Union[Asset, str]): Currency code. Supported assets: “BTC”, “TON”, “ETH”, “USDT”, “USDC” and “BUSD”.
    ...
    async def get_transfers(
        ...
        https://help.crypt.bot/crypto-pay-api#RjDU

        Args:
            asset (Optional[Union[Asset, str]], optional): Currency codes separated by comma. Supported assets: “BTC”, “TON”, “ETH”, “USDT”, “USDC” and “BUSD”. Defaults to all assets.
    ...
    async def create_check(
        self, asset: Union[Asset, str], amount: Union[int, float]
    ) -> Check:
        """
        Use this method to create a new check.
        https://help.crypt.bot/crypto-pay-api#ZU9K

        Args:
            asset (Union[Asset, str]): Cryptocurrency alphabetic code. Supported assets: “USDT”, “TON”, “BTC”, “ETH”, “LTC”, “BNB”, “TRX” and “USDC” (and “JET” for testnet).
    ...
    async def get_checks(
        ...
        https://help.crypt.bot/crypto-pay-api#nIwG

        Args:
            asset (Optional[Union[Asset, str]], optional): _description_. Defaults to None.
    ...
    async def delete_check(self, check_id: int) -> bool:
        ...
        https://help.crypt.bot/crypto-pay-api#nd2L
    ...
    async def get_amount_by_fiat(
        ...
        Args:
            ...
            asset (Union[Asset, str]): Crypto currency code.
    ...
    def register_pay_handler(self, func: Callable) -> None:
        """
        Register handlers when invoice paid.
